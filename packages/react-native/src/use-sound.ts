...
import type { SoundAsset, UseSoundOptions, UseSoundReturn, SoundPlayback } from "@soundcn/engine";
import { ExpoAudioEngine } from "./engine";
...
export function useSound(
  ...
  return [play, { stop, pause, isPlaying, duration: sound.duration ?? null, sound }] as const;
}
